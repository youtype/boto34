"""
Wrapper for aioboto3 ElasticInference service.

[Documentation](https://youtype.github.io/types_aioboto3_docs/types_aiobotocore_elastic_inference/)
...
Usage::
    ...
    # Returns type annotated aioboto3 ElasticInference client
    elastic_inference_client = session.elastic_inference.client()
