...
class Session(_Session):
    ...
    @property
    def cloudformation(self) -> ServiceFactory[CloudFormationClient]:
        return ServiceFactory("cloudformation", self)
    ...
    @property
    def cloudwatch(self) -> ServiceFactory[CloudWatchClient]:
        return ServiceFactory("cloudwatch", self)
    ...
    @property
    def dynamodb(self) -> ServiceFactory[DynamoDBClient]:
        return ServiceFactory("dynamodb", self)
    ...
    @property
    def ec2(self) -> ServiceFactory[EC2Client]:
        return ServiceFactory("ec2", self)
    ...
    @property
    def glacier(self) -> ServiceFactory[GlacierClient]:
        return ServiceFactory("glacier", self)
    ...
    @property
    def iam(self) -> ServiceFactory[IAMClient]:
        return ServiceFactory("iam", self)
    ...
    @property
    def opsworks(self) -> ServiceFactory[OpsWorksClient]:
        return ServiceFactory("opsworks", self)
    ...
    @property
    def s3(self) -> ServiceFactory[S3Client]:
        return ServiceFactory("s3", self)
    ...
    @property
    def sns(self) -> ServiceFactory[SNSClient]:
        return ServiceFactory("sns", self)
    ...
    @property
    def sqs(self) -> ServiceFactory[SQSClient]:
        return ServiceFactory("sqs", self)
