...
try:
    ...
    LocationServicePlacesV2Client = object  # type: ignore[misc,assignment]


class LocationServicePlacesV2Service(
    ServiceFactory[LocationServicePlacesV2Client]  # type: ignore[misc,assignment]
):
