...
Usage::
    ...
    # Returns type annotated boto3 DynamoDBStreams client
    dynamodbstreams_client = session.dynamodbstreams.client()
    dynamodbstreams_client: types_boto3_dynamodbstreams.client.DynamoDBStreamsClient
    ```
"""
