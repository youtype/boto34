...
Usage::
    ...
    # Returns type annotated boto3 SagemakerEdgeManager client
    sagemaker_edge_client = session.sagemaker_edge.client()
    sagemaker_edge_client: types_boto3_sagemaker_edge.client.SagemakerEdgeManagerClient
    ```
"""
