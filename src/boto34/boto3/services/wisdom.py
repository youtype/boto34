...
Usage::
    ...
    # Returns type annotated boto3 ConnectWisdomService client
    wisdom_client = session.wisdom.client()
    wisdom_client: types_boto3_wisdom.client.ConnectWisdomServiceClient
    ```
"""
